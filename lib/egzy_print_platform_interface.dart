...
import 'egzy_print_method_channel.dart';

abstract class EgzyPrintPlatform extends PlatformInterface {
  /// Constructs a EgzyPrintPlatform.
  EgzyPrintPlatform() : super(token: _token);

  static final Object _token = Object();

  static EgzyPrintPlatform _instance = MethodChannelEgzyPrint();

  /// The default instance of [EgzyPrintPlatform] to use.
  ///
  /// Defaults to [MethodChannelEgzyPrint].
  static EgzyPrintPlatform get instance => _instance;

  /// Platform-specific implementations should set this with their own
  /// platform-specific class that extends [EgzyPrintPlatform] when
  /// they register themselves.
  static set instance(EgzyPrintPlatform instance) {
  ...
  Future<bool?> getInstallServiceApk() {
    throw UnimplementedError(
        'getInstallServiceApk() has not been implemented.');
  }
  ...
  void setDisplayControlStatusBarByBroadcast(bool enable) {
    throw UnimplementedError(
        'setDisplayControlStatusBarByBroadcast() has not been implemented.');
  }

  void setDisplayControlNavigationBarByBroadcast(bool enable) {
    throw UnimplementedError(
        'setDisplayControlNavigationBarByBroadcast() has not been implemented.');
  }

  Future<String?> setDisplayControlStatusBar(bool enable) {
    throw UnimplementedError(
        'setDisplayControlStatusBar() has not been implemented.');
  }

  Future<String?> setDisplayControlNavigationBar(bool enable) {
    throw UnimplementedError(
        'setDisplayControlNavigationBar() has not been implemented.');
  }
