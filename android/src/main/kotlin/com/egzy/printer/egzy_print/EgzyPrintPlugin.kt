package com.egzy.printer.egzy_print
...
/** EgzyPrintPlugin */
class EgzyPrintPlugin: FlutterPlugin, MethodCallHandler {
  ...
  override fun onAttachedToEngine(flutterPluginBinding: FlutterPlugin.FlutterPluginBinding) {
    channel = MethodChannel(flutterPluginBinding.binaryMessenger, "egzy_print")
    ...
    eventChannel = EventChannel(flutterPluginBinding.binaryMessenger, "egzy_print/result")
